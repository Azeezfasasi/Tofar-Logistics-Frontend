        ...
        <div className="bg-gray-50 rounded-xl shadow-lg overflow-hidden flex flex-col lg:flex-row items-stretch mb-16">
          ...
          <div className="lg:w-1/2 p-8 flex flex-col justify-center text-left">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Founded in 2016, Tofar Logistics Agency has grown into a trusted force in the logistics and supply chain industry. Our mission is rooted in reliability, transparency, and delivering excellence across every shipment and service we provide.      
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              We are committed to moving goods efficiently and securely while building long-lasting partnerships with our clients. At Tofar Logistics Agency and Logistics, we believe in going beyond transportation, we deliver confidence, speed, and tailored logistics solutions that drive global trade forward.
            </p>
